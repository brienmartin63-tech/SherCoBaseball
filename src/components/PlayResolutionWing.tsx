  ...
  return (
    ...
    >
      ...
      <div className="wing-board">
        ...
        <div className="wing-cell"><span>To ball</span><b>{fielding?.fieldingDistance ?? "—"}</b></div>
        ...
        <div className="wing-cell"><span>Allowance</span><b>{fielding?.throwingAllowance ?? "—"}</b></div>
        <div className="wing-cell"><span>After fielding</span><b>{fielding?.throwingRemainder ?? "—"}</b></div>
        <div className="wing-cell"><span>Target</span><b>{fielding?.targetBase ?? "—"}</b></div>
      </div>
